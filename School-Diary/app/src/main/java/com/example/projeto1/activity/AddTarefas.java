...
public class AddTarefas extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText addtitle, addnote;
    TextView adddate;
    FloatingActionButton btnsubtmit;
    Calendar calendar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.addsubject);
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddTarefas.this, Tarefa.class);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (position == 1) { // "Adicionar Nova Disciplina"
                    Globals.globaladdisciplina = 2;
                    Intent intent = new Intent(AddTarefas.this, AddDisciplina.class);
                    startActivity(intent);
                }
        ...
        btnsubtmit = findViewById(R.id.btnaddta);
        ...
        btnsubtmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (addtitle.getText().toString().trim().isEmpty()) {
                    addtitle.requestFocus();
                    addtitle.setError("Não pode estar vazio");
                    return;
                }


                if (adddate.getText().toString().trim().isEmpty()) {
                    adddate.setError("Não pode estar vazio");
                ...
                new DataBase(AddTarefas.this).addTarefa(
                        addtitle.getText().toString().trim(),
                        addnote.getText().toString().trim(),
                        adddate.getText().toString().trim(),
                        disciplina.getId());
    ...
    public ArrayList<DisciplinaModel> getInformation() {
        ...
        DataBase db = new DataBase(AddTarefas.this);
